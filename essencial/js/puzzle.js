...
function celebrate() {
  ...
  toMain.onclick = () => { window.location.href = 'https://juegosinfantiles.tecnica4berazategui.edu.ar/essencial/principal.html'; };
...
async function sendPoints(points) {
  ...
  try {
  const resp = await fetch('https://juegosinfantiles.tecnica4berazategui.edu.ar/essencial/excepcional/sumar_puntos.php', {
      method: 'POST',
