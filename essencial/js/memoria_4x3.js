...
allCards.forEach(card => {
  card.addEventListener("click", () => {
    ...
    if (!firstCard) {
      ...
      // prevent further clicks until this pair is resolved
      lockBoard = true;
...
function checkMatch(card1, card2) {
  if (card1.textContent === card2.textContent) {
    ...
    setTimeout(() => {
      ...
      // unlock board after cards are flipped back
      lockBoard = false;
    }, 800);
  }
}
...
function gameOver(won) {
  ...
  window.location.href = '/juegos/Memoria/index.html';
    }, 'btn btn-success'));
  } else {
  ...
  window.location.href = 'https://juegosinfantiles.tecnica4berazategui.edu.ar/juegos/Memoria/index.html';
  }, 'btn btn-secondary'));
